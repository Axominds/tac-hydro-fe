...
const sdgData = [
  {
    ...
    description:
      "We develop reliable, clean hydropower projects that strengthen energy security and reduce dependence on fossil fuels.",
    color: "#FDB713",
    label: "CLEAN POWER",
  ...
  },
  {
    ...
    description:
      "We create skilled employment and build local technical capacity through responsible engineering practices.",
    color: "#A21942",
    label: "LOCAL GROWTH",
  ...
  },
  {
    ...
    description:
      "We deliver innovative engineering solutions across the full hydro cycle from identification to construction supervision.",
    color: "#FD6925",
  ...
  },
  {
    ...
    description:
      "By promoting renewable energy and climate-resilient designs, we contribute to long-term carbon emission reduction.",
    color: "#3F7E44",
    label: "LOW CARBON",
    ...
    <section id="sdg-section" className="w-full py-10 sm:py-16 bg-[#f8f9fa]">
      <div className="max-w-[1240px] mx-auto px-6 sm:px-8">
        ...
        <p className="text-[#555555] text-lg leading-relaxed mb-8 max-w-4xl">
          TAC Hydro Consultancy Pvt. Ltd. aligns its engineering services with the United Nations
          Sustainable Development Goals through practical, project-based actions:
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {sdgData.map((sdg) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-[#2c3e50] mb-4">{sdg.title}</h3>

...
const sectorData = [
    {
        ...
        title: "Hydropower",
        description:
            "Full-cycle development including feasibility studies, detailed design, and construction supervision for civil, HM, and EM works.",
    },
    {
        id: 2,
        ...
        title: "Tunnel",
        description:
            "Specialized design and structural analysis for power tunnels and transport infrastructure in complex geological conditions.",
    },
    {
        id: 3,
        ...
        description:
            "End-to-end solutions for power evacuation, including route surveys, tower spotting, and grid connection design.",
    },
    {
        id: 4,
        ...
        title: "Road",
        description:
            "Design and supervision of resilient access roads and transport networks in challenging terrains.",
    },
    {
        id: 5,
        ...
        title: "Environment",
        description:
            "Comprehensive environmental assessments (IEE/EIA) and sustainability planning to ensure regulatory compliance and ecological balance.",
    },
    {
        id: 6,
        ...
        description:
            "Hydraulic engineering for canal systems, headworks, and sustainable water management projects.",
    },
];

        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,520px)_1fr] gap-12 items-center">
          ...
          <div>
            <div className="mission-panel">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-white shadow-[0_4px_8px_rgba(0,0,0,0.12)] text-[11px] tracking-[0.08em] font-semibold text-[#2b2b2b] mb-6">
                MISSION &amp; VISION
              </div>

              <h2 className="font-bold text-[#1b1b1b] text-3xl sm:text-4xl lg:text-[40px] leading-[1.12] mb-2">
                Guided by Purpose,
              </h2>
              <h2 className="font-bold text-[#1b1b1b] text-3xl sm:text-4xl lg:text-[40px] leading-[1.12] mb-4">
                Built for Impact.
              </h2>

              <p className="font-normal text-[#5a5a5a] text-sm sm:text-base leading-[24px] max-w-[520px] mb-7">
              ...
              <div className="space-y-5">
                <div className="flex items-start gap-4 rounded-[18px] bg-white px-6 py-5 shadow-[0_12px_18px_rgba(0,0,0,0.12)]">
                  ...
                  <div>
                    ...
                    <p className="font-normal text-[#5a5a5a] text-sm leading-[20px]">

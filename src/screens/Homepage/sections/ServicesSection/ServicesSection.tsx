      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 px-6 lg:px-16 py-12 lg:py-20">
        ...
        <div className="flex flex-col gap-6 max-w-2xl">
          <div className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:200ms]">
            <p className="[font-family:'Inter',Helvetica] font-normal text-[#6b8f7b] text-xs tracking-[0] leading-[normal] uppercase">
          ...
          <div className="translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:800ms]">
            <Button className="h-auto bg-[#6b8f7b] hover:bg-[#5a7a68] text-white px-8 py-3 rounded-md transition-colors [font-family:'Inter',Helvetica] font-bold italic text-sm">
              Get A Quote →
            </Button>
          </div>
        </div>

...
export const ProjectsSection = (): JSX.Element => {
  return (
    <section className="relative w-full min-h-[360px] sm:min-h-[460px] lg:h-[520px] overflow-hidden">
      <div className="absolute inset-0 h-full w-full">
        ...
        <div className="relative z-10 h-full max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-20 flex flex-col justify-center">
          <div className="max-w-[680px]">
            ...
            <h2 className="[font-family:'Playfair_Display',Helvetica] font-semibold italic text-white text-3xl sm:text-4xl lg:text-[44px] tracking-[0] leading-[1.1] mb-3">
              {projectSlide.title}
            </h2>
            <p className="[font-family:'Inter',Helvetica] font-normal text-white text-sm sm:text-base tracking-[0] leading-[24px]">

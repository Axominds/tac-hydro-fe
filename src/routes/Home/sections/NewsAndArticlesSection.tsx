...
const newsItems = [
  {
    ...
    date: "JAN 12, 2024",
    description:
      "Exploring the latest innovations and milestones in our journey towards sustainable energy excellence.",
  },
  {
    id: 2,
...
export const NewsAndArticlesSection = () => {
  ...
  return (
    <section
      ...
      className="relative w-full bg-[#f8f9fa] py-20 lg:py-28 overflow-hidden"
    >

        ...
        <div className="relative w-full h-full">
          ...
          <div className="relative w-full px-[4.17%] pt-[21.93%] pb-[53.08%]">
            <div className="max-w-[42.63%]">
              <h2 className="[font-family:'Playfair_Display',Helvetica] font-bold italic text-white text-[44px] tracking-[0] leading-[normal] mb-4">
                Project Development
              </h2>

              <p className="max-w-[89.96%] [font-family:'Inter',Helvetica] font-normal text-[#ededed] text-base tracking-[0] leading-[normal]">

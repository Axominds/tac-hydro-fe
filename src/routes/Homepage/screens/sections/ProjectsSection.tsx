            ...
            {navigationItems.map((item, index) => (
              <button
                ...
                className={`[font-family:'Inter',Helvetica] ${
                  item.active ? "font-bold italic text-[#111111]" : "font-normal text-[#888888]"
                } text-[13px] tracking-[0] leading-[normal] hover:text-[#111111] transition-colors`}
              >
                {item.label}
              </button>
            ))}
            ...
            {smallArticles.map((article, index) => (
              ...
              >
                <CardContent className="p-0">
                  ...
                  <div className="mt-4">
                    <h4 className="[font-family:'Inter',Helvetica] font-bold italic text-[#111111] text-base tracking-[0] leading-[normal]">
                      {article.title}
                    </h4>
                    <p className="[font-family:'Inter',Helvetica] font-bold italic text-[#111111] text-base tracking-[0] leading-[normal] mt-1">
                      {article.subtitle}
                    </p>
                    <div className="flex items-center gap-3 mt-3">
                      <Badge
                        variant="secondary"
                        className="[font-family:'Inter',Helvetica] font-normal text-[#2a7fff] text-xs tracking-[0] leading-[normal] bg-transparent hover:bg-transparent px-0"
                      >
                        {article.category}
                      </Badge>

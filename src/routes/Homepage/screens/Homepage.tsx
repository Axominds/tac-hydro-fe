    ...
    <div className="w-full relative bg-white">
      ...
      <section className="relative w-full py-16 sm:py-20 bg-[#f8f9fa]">
        <div className="max-w-[900px] mx-auto px-6 sm:px-8 text-center">
          <h2 className="[font-family:'Playfair_Display',Helvetica] font-bold italic text-[#2c3e50] text-3xl sm:text-4xl lg:text-[44px] tracking-[0] leading-[normal] mb-6">
            Who we are
          </h2>
          <p className="[font-family:'Montserrat',Helvetica] font-normal text-[#555555] text-base sm:text-lg tracking-[0] leading-[30px] sm:leading-[32px] mb-4">
            ...
            >
                ...
                {stats.map((stat, index) => (
                  <div key={index} className="text-left opacity-100">
                    <div className="relative w-full max-w-[220px] opacity-100">
                      <span className="[font-family:'Gothic_A1',Helvetica] font-bold text-[#4f4f4f] text-6xl sm:text-7xl lg:text-[140px] leading-[1]">
                        {counts[index]}
                        {stat.number.replace(/[0-9.]/g, "")}
                      </span>
                      <span className="[font-family:'Gothic_A1',Helvetica] font-medium text-[#4f4f4f] text-sm sm:text-base leading-none tracking-[0] opacity-100 absolute right-0 top-6 bg-white px-2 py-1 flex items-center justify-center">
                        {stat.label}
                      </span>
                    </div>
                    <p className="[font-family:'Gothic_A1',Helvetica] font-medium text-[#6b6b6b] text-base sm:text-lg leading-[1.2] tracking-[0] mt-2 max-w-[220px]">
                      {stat.description}
                    </p>
                  </div>
                ))}
              ...
              <div className="flex flex-col gap-5">
                <div className="grid grid-cols-[80px_1fr] gap-4 items-start">
                  <span className="[font-family:'Gothic_A1',Helvetica] font-bold text-[#0070c0] text-base sm:text-lg leading-[1] tracking-[0]">
                    Vision
                  </span>
                  <p className="[font-family:'Gothic_A1',Helvetica] font-normal text-[#666666] text-sm sm:text-base lg:text-[18px] leading-[26px] sm:leading-[28px] tracking-[0] text-justify">
      ...
      <section className="relative w-full py-16 sm:py-20 bg-[#F4F1E1]">
        <div className="max-w-[900px] mx-auto px-6 sm:px-8 text-center">
          <h2 className="[font-family:'Playfair_Display',Helvetica] font-bold italic text-[#2c3e50] text-3xl sm:text-4xl lg:text-[44px] tracking-[0] leading-[normal] mb-4">
            We make every trip a harmonious
          </h2>
          <h2 className="[font-family:'Playfair_Display',Helvetica] font-bold italic text-[#2c3e50] text-3xl sm:text-4xl lg:text-[44px] tracking-[0] leading-[normal] mb-6">
            blend of comfort and discovery.
          </h2>
          <p className="[font-family:'Montserrat',Helvetica] font-normal text-[#555555] text-base sm:text-lg tracking-[0] leading-[normal] mb-8">

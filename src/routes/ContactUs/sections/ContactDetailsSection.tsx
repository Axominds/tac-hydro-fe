                        ...
                        <div className="relative z-10">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-start gap-4 group">
                                    ...
                                    <div>
                                        <p className="text-[11px] text-blue-400 uppercase tracking-[0.2em] font-bold mb-1">Email Us</p>
                                        <a href="mailto:service@tachydro.com.np" className="text-lg font-semibold hover:text-blue-400 transition-colors break-all">
                        ...
                        <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="flex flex-col gap-2.5">
                                    <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest ml-1">Your Name</label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex flex-col gap-2.5">
                                    <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest ml-1">Phone Number</label>
                                    <input
                                        type="tel"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="flex flex-col gap-2.5">
                                    <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest ml-1">Desired Service</label>
                            ...
                            <div className="flex flex-col gap-2.5">
                                <label className="text-[12px] font-bold text-slate-500 uppercase tracking-widest ml-1">Message</label>
                                <textarea

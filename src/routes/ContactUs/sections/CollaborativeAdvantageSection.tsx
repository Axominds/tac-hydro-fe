      ...
      <div className="mx-auto max-w-[1400px] px-6 sm:px-10 lg:px-20 w-full">
        <div className="flex flex-col gap-6 text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-[#6b6b6b] max-w-[800px] mx-auto">
            Partnering with TAC Hydro ensures a foundation of technical excellence, ethical
            practice, and global engineering benchmarks.
          </p>
        </div>
          ...
          {[
            {
              title: "Innovation",
              description:
                "Driving progress through creative problem-solving and cutting-edge engineering techniques in every project phase.",
              icon: <Lightbulb className="w-8 h-8 text-blue-600" />,
            },
            {
              title: "Sustainability",
              description:
                "Prioritizing environmental stewardship and long-term ecological balance in all hydraulic design and implementation.",
              icon: <Leaf className="w-8 h-8 text-green-600" />,
            },
            {
              title: "Tailored Solutions",
              description:
                "Delivering customized engineering approaches that meet the unique technical and topographical needs of every site.",
              icon: <Puzzle className="w-8 h-8 text-purple-600" />,
            },
            {
              title: "Technical Expertise",
              description:
                "Leveraging deep institutional knowledge and technical precision for complex infrastructure and energy systems.",
              icon: <Cpu className="w-8 h-8 text-slate-600" />,
            },
            {
              title: "Quality management",
              description:
                "Ensuring every deliverable meets and exceeds global industry benchmarks and international standard alignment.",
              icon: <CheckCircle className="w-8 h-8 text-teal-600" />,
            },
            {
              title: "Strong ethics",
              description:
                "Upholding the highest standards of integrity, transparency, and professional conduct across all partnerships.",
              icon: <ShieldCheck className="w-8 h-8 text-indigo-600" />,
            },
            {
              title: "Cost Effectiveness",
              description:
                "Optimizing resources to deliver high-value outcomes without compromising on performance or structural safety.",
              icon: <Coins className="w-8 h-8 text-amber-600" />,
            },
            {
              title: "Outstanding Results",
              description:
                "Measuring our success through the measurable impact and satisfaction of our partners and final project outcomes.",

  ...
  const ecosystemItems = [
    {
      ...
      description:
        "Hydropower developers seeking high-reliability design and strategic consultancy for large-scale energy assets.",
      icon: <Building2 className="w-6 h-6 text-blue-600" />,
    },
    {
      title: "Consulting Firms",
      description:
        "Global engineering and consultancy entities seeking regional sub-consultancy or joint venture participation.",
      icon: <Users className="w-6 h-6 text-green-600" />,
    },
    {
      title: "Technical Specialists",
      description:
        "Experts in niche geology, environmental safeguards, and specialized electro-mechanical systems.",
      icon: <Wrench className="w-6 h-6 text-purple-600" />,
    },
    {
      title: "Academic & Research",
      description:
        "Collaborative research on river dynamics and innovative sustainable energy technology with leading institutions.",
      ...
      <div className="mx-auto max-w-[1200px] px-6 sm:px-10 lg:px-20 w-full">
        <div className="flex flex-col gap-6 text-center mb-16">
          ...
          <p className="text-base sm:text-lg text-[#6b6b6b] max-w-[900px] mx-auto leading-relaxed">
            We provide the strategic bridge for the entire hydropower lifecycle offering developers
            bankable designs, firms local agility, specialists a platform for niche expertise, and
            researchers a pathway to real-world application.
          </p>
        </div>
            ...
            >
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-base text-[#6b6b6b] leading-relaxed">{item.description}</p>
                </div>
              </div>
            </div>
          ))}

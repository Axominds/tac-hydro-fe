    ...
    return (
        <section id="general-drop-cv" className="w-full py-20 bg-[#f8f9fa] px-4 sm:px-8 lg:px-20">
            <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">Not finding the right fit today?</h2>
                <p className="text-gray-600 mb-10 text-lg leading-relaxed max-w-2xl mx-auto">
                    We are always looking for visionary professionals to help us power the future. If you are a motivated professional looking to apply your expertise within the dynamic field of hydropower consultancy, we invite you to share your profile with us. Connect with us for future opportunities.
                </p>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                <select className="w-full px-4 py-3 rounded-lg bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#0b1522] transition-all" required>
                        ...
                        <div
                            ...
                            className={cn(
                                ...
                                cvFile ? "bg-blue-50 border-blue-400" : "border-gray-300 hover:bg-gray-50 hover:border-blue-400"
                            )}
                        >
                            <input
                            ...
                            <div className={cn(
                                ...
                                <UploadIcon className={cn("h-6 w-6 transition-colors", cvFile ? "text-blue-600" : "text-gray-500")} />
                            </div>
                        ...
                        <Button type="submit" className="w-full py-7 text-lg font-bold mt-4 bg-blue-600 hover:bg-blue-700 shadow-xl transition-all duration-300 flex items-center justify-center gap-3">

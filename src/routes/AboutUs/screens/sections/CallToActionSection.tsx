        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative">
          ...
          <div className="relative space-y-6">
            <div className="relative">
              ...
              <div className="[text-shadow:0px_0px_4px_#00000040] [-webkit-text-stroke:1px_#000000] font-bold text-[#2b2b2b] text-xs leading-[normal] mb-4">
                MISSION &amp; VISION
              </div>

              <h2 className="font-bold text-[#111111] text-[46px] leading-[normal]">
                Guided by Purpose,
              </h2>

              <h2 className="font-bold text-[#111111] text-[46px] leading-[normal] mb-6">
                Built for Impact.
              </h2>

              <div className="space-y-1 mb-8">
                <p className="font-normal text-[#555555] text-base leading-[normal]">
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-[#111111] text-lg leading-[normal] mb-3">
                          {item.title}
                        </h3>
                        <div className="space-y-1">
                          {item.description.map((line, lineIndex) => (
                            <p
                              key={lineIndex}
                              className="font-normal text-[#555555] text-sm leading-[normal]"
                            >
                              {line}
                            </p>
                          ))}

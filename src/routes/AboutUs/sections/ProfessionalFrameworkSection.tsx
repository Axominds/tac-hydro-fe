...
export const ProfessionalFrameworkSection = () => {
  return (
    <section>
      <section
        id="professional-framework-text"
          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            <div className="w-full md:w-1/2">
              ...
              <div className="space-y-6 text-slate-700 leading-relaxed text-justify">
                <p>
                  TAC Hydro Consultancy Pvt. Ltd. offers comprehensive engineering solutions that
                  extend well beyond hydropower. Our expertise encompasses{" "}
                  <span className="font-semibold text-[#0b1522] bg-blue-50 px-1 rounded">
                    tunnel engineering
                  </span>
                  ,{" "}
                  <span className="font-semibold text-[#0b1522] bg-blue-50 px-1 rounded">
                ...
                <p>
                  We are guided by a strong commitment to{" "}
                  <span className="font-semibold text-[#0b1522]">innovation</span>,{" "}
                  <span className="font-semibold text-[#0b1522]">sustainability</span>, and{" "}
                  <span className="font-semibold text-[#0b1522]">cost-effectiveness</span>, ensuring
                  that every project we undertake delivers long-term value. Our team's technical
                  proficiency, thorough approach, and dedication to quality outcomes enable us to
                  consistently meet and exceed client expectations.
                </p>
                <p>
                  We take pride in being a trusted and dependable partner—focused on delivering
                  professional excellence and tailored solutions across the infrastructure and
                  energy sectors.
                </p>
              </div>
            </div>
            ...
            {frameworkItems.map((item, idx) => (
              ...
              >
                <div className={`relative mb-8 flex items-center justify-center`}>
                  ...
                  <div
                    className={`w-16 h-16 rounded-2xl ${item.color} flex items-center justify-center text-white shadow-lg transition-transform duration-500 group-hover:rotate-[360deg]`}
                  >

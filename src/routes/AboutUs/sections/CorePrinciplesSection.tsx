                        ...
                        <div className="w-full md:w-1/2">
                            ...
                            <div className="space-y-6 text-slate-700 leading-relaxed text-justify">
                                ...
                                <p>
                                    ...
                                    <span className="font-semibold text-[#0b1522]">integrity</span>,{" "}
                                    <span className="font-semibold text-[#0b1522]">sustainability</span>, and{" "}
                                    <span className="font-semibold text-[#0b1522]">innovation</span>, ensuring
                                    that every project we undertake delivers long-term value. Our team's technical
                                    excellence, thorough approach, and dedication to quality outcomes enable us to
